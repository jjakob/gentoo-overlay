...
src_prepare() {
	...
	# https://commits.webkit.org/292321@main https://bugs.webkit.org/show_bug.cgi?id=289669
	eapply "${FILESDIR}"/2.46.6-EnumTraits.h-error-no-matching-function-for-call-to-.patch
